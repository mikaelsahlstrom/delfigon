...
*
* Target
*  - Compiler: g++  -m32 -pthread -fstack-protector -std=c++11 -D_REENTRANT -O2 -momit-leaf-frame-pointer
*  - Arch: x86_32/x86_32
*  - OS: linux
*/

#error Make sure botan settings in build.h match the target machine and your preferences!
